...
class Connexion_LPG_SYSTEMS
{
   ...
   * @var string
   */
  const DEFAULT_SQL_USER = 'weblpg_corpo';
   ...
   * @var string
   */
  const DEFAULT_SQL_PASS = 'Scam53$0';
   ...
   * @var string
   */
  const DEFAULT_SQL_DTB = 'weblpg_corpo';
  ...
  {  
    ...
    {
      self::$instance = new Connexion_LPG_SYSTEMS();
    }
