...
class Connexion_MEDICAL
{
   ...
   * @var string
   */
  const DEFAULT_SQL_USER = 'lpguser';
   ...
   * @var string
   */
  const DEFAULT_SQL_PASS = '9jBx4m%2';
   ...
   * @var string
   */
  const DEFAULT_SQL_DTB = 'lpgmedical';
  ...
  {  
    ...
    {
      self::$instance = new Connexion_MEDICAL();
    }
